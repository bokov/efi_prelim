...
[[\@Bokov, Alex F](styles.xml) TODO: see if the literature supports a stronger statement than \'mainly\']{.comment-start id="0" author="Bokov, Alex F"
date="2020-10-16T08:30:43Z"}mainly []{.comment-end id="0"}
...
healthcare.  {Friedman C, Rubin J, Brown J, et al. Toward a science of learning
systems: a research agenda for the high-functioning learning health system. J Am
Med Inform Assoc.2015;22:43–50.doi:10.1136/amiajnl-2014-002977}

::: {.note2team custom-style="bnote2team"}
[NOTE FROM KS:  The following paragraph is the more detailed background of the
anchoring report on LHS from the IOM.  Provided FYI, not necessarily to include
in full narrative. KS]
:::
...
prodownloadmote and enable continuous and real-time improvement in both the
effectiveness and efficiency of care—is both necessary and possible for the
nation.” (IOM, 2013, p. 21)

{Institute of Medicine (IOM).  2013.  Best Care at Lower Cost:  The Path to
Continuously Learning Health Care in America. Washington, DC:  National
Academies Press.}   https://doi.org/10.17226/13444.
...
Following principles of implementation science {Meissner, Paul, Linda B.
Cottler, and J. Lloyd Michener. "Engagement science: The core of dissemination,
implementation, and translational research science." Journal of Clinical and
Translational Science 4, no. 3 (2020): 216-218.}, clinical stakeholders and
experts (SE, CT) were directly engaged in the research design to identify key
outcomes that were meaningful, relevant, and useful in guiding clinical care
planning. We applied patient safety indicators used for routine large-scale
surveillance of hospital and health system performance {Southern, Danielle A.,
Bernard Burnand, Saskia E. Droesler, Ward Flemons, Alan J. Forster, Yana
Gurevich, James Harrison et al. "Deriving ICD-10 codes for patient safety
indicators for large-scale surveillance using administrative hospital data."
Medical care 55, no. 3 (2017): 252-260} and extended the data set to include
...
baseline characteristics of the testing cohort are shown in 
...
age, number of visits?]{.comment-start id="1" author="Bokov, Alex F"
date="2020-10-16T08:36:49Z"}Table []{.comment-end
id="1"} \@ref(tab:table1).
...
[[\@Bokov, Alex F](https://doi.org/10.17226/13444)
COMMENT
]{.comment-start id="999" author="Bokov, Alex F"
date="December, 2020"} CONTENT []{.comment-end id="999"}

`r print(foo<-note('Text one.','Regular comment'))` 
More spacer text. Lorem ipsum. 
`r note('Field three used.','Field3 has value',field3='[#FIELD3]')`. Lorem ipsum 
`r note('No date','No date comment',date='')`. blarg balasdf `r foo`. Done.
...
[[\@Bokov, Alex F](https://www.nap.edu/catalog/13444/best-care-at-lower-cost-the-path-to-continuously-learning)
TODO: Also say how many (number and %) of the frail and non-frail groups
experienced each event. Or, maybe put it into the table.]{.comment-start
id="3" author="Bokov, Alex F" date="2020-10-16T08:39:11Z"}
For each 0.1 increase in
EFI, we found at least a doubling of risk: `r pander(snip_resultsfold)`.
[[\@Bokov, Alex
F](https://doi.org/10.17226/13444) TODO: Fill in the appropriate values for
these placeholders.]{.comment-start id="4" author="Bokov, Alex F"
date="2020-10-16T08:46:37Z"}
...
[[\@Bokov, Alex F](http://dx.doi.org/10.1136/amiajnl-2014-002977) Report a comparison between the developmental and test data.]{.comment-start id="2" author="Bokov, Alex F" date="2020-10-16T08:42:00Z"}highly significant[]{.comment-end id="2"}. 
...
[[\@Stevens, Kathleen]() Can we make a parallel statement in our CONCLUSIONS? 
...
]{.comment-start id="6" author="Stevens, Kathleen"
date="2020-10-16T08:30:43Z"}... []{.comment-end id="6"}
