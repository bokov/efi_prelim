...
`r note('Insofar that any other decisions about processing and statistical analysis 
...
lapply(valresults[.outcomenames]
  ...
  pander(row.names=F,caption='(\\#tab:lmdiscrim) Validation against developmental data.',keep.line.breaks=T)
```
...
,"Did I get everybody's correctly?",date='2020-12-04T14:20')` `r note("The 
