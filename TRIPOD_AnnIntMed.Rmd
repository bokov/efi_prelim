...
patient outcomes in real-world EHR data. Our results add to the evidence that
...
`r subset(valresultsout,Outcome!='(Intercept)')$estimate %>% range %>% nb(digits=2) %>% paste(collapse=' - ')`
